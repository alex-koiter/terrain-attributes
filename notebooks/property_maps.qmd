...
#| fig-asp: 2
#| label: fig-ag_map
#| fig-cap: Kriged maps of colour and geochemical properties and elevation across the agricultural site.
 
p_ag <- ca + co + cs + fe + li + la + nb + ni + rb + sr + a_col + b_col + c_col + h_col + x_col + scale_p + plot_layout(ncol = 4) 
...
#| fig-cap: Kriged map of colour and geochemical properties and elevation across the forested site.
 
p_for <- ca_forest + co_forest + cs_forest + la_forest + li_forest + nb_forest + ni_forest + sr_forest + h_col_forest + scale_p +
  plot_layout(ncol = 4) 
p_for
