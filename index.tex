...
\hypersetup{
  pdftitle={Investigating the Use of Terrain Attributes in Characterizing Soil Geochemistry and Colour Properties},
...
\begin{frontmatter}
\title{Investigating the Use of Terrain Attributes in Characterizing
Soil Geochemistry and Colour Properties}
...
Everything is base on the 49 points only to compare to interpolated data
see
